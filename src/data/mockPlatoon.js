...
export const buddyTapSelectableMembers = platoonMembers.filter((member) => !member.isSelf);
export const peerSupportLead = platoonMembers.find((member) => member.role === 'peer-support');
export const sectionMates = platoonMembers.filter((member) => member.section === '1' && !member.isSelf);
